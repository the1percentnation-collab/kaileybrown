...
1. Open <https://console.firebase.google.com/project/kaileybrown-48e22/usage/details>
...
1. Open <https://console.firebase.google.com/project/kaileybrown-48e22/firestore>
...
1. Open <https://console.firebase.google.com/project/kaileybrown-48e22/authentication/providers>
...
2. Once the backend workflow is green, visit <https://kaileybrown-48e22.web.app/signup.html> and create an account with **kailey@kaileybrown.com**. (Or sign in with that Google account.)
3. Go to <https://kaileybrown-48e22.web.app/owner.html>. You'll see a notice that you are not yet an owner. Click **Run bootstrapOwner**.
...
1. Open <https://console.cloud.google.com/iam-admin/iam?project=kaileybrown-48e22>
2. Find the service account tied to the existing GitHub workflow (looks like `github-action-XXXXXXXXX@kaileybrown-48e22.iam.gserviceaccount.com`).
3. Add these roles:
...
npx firebase-tools deploy --only firestore:rules,functions --project kaileybrown-48e22
```
...
1. `https://kaileybrown-48e22.web.app/login.html` — sign in as the owner email.
